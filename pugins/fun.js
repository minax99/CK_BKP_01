...
cmd({
    ...
    let roasts = [
       "Hey brother, your IQ is less than wifi signal!",
        "Bhai, your thoughts are like WhatsApp status, which disappears after 24 hours!",
        "How much have you thought, are you a NASA scientist?",
        "Who are you? Even searching on Google doesn't bring up your name!",
        "Is your mind running on 2G network?",
        "Brother, don't overthink so much, your battery will go down soon!",
        "Your thought is like a cricket match, rain is coming and it is raining!",
];               
